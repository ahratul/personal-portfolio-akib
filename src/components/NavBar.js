        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#employment" className={activeLink === 'employment' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('employment')}>Employment History</Nav.Link>
              ...
              <Nav.Link href="#references" className={activeLink === 'references' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('references')}>References</Nav.Link>
